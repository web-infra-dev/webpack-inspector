...
import { guessMode, clearRoot } from '../logic/utils';
...
// onMounted(() => {
//   const cm1 = useCodeMirror(fromEl, from, {
//     mode: 'javascript',
//     readOnly: true,
//     lineNumbers: true,
//     scrollbarStyle: 'null',
...
//   const cm2 = useCodeMirror(toEl, to, {
//     mode: 'javascript',
//     readOnly: true,
//     lineNumbers: true,
//     scrollbarStyle: 'null',
...
<template>
  <div class="w-300 h-300">
    ...
    <!-- <MonacoEditor :diff="true" origin="from"> </MonacoEditor> -->
